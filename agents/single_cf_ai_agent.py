# Universal auto-generated wrapper v3 for 'single_cf'
from importlib import import_module
import pkgutil, inspect

ROOT_PKG = "agents._vendor.single_cf"
...
def _call_entry(entry, payload):
    try:
        ...
        return {"status":"ERROR","agent":"single_cf","error":str(e)}
...
def run(payload=None):
    ...
    for _, fqname, entry, _ in _CANDS[:10]:  # ลองตัวเต็ง 10 อันดับแรก
        ...
        if isinstance(res, dict) and res.get("status")=="ERROR":
            ...
            continue
        # สำเร็จ
        return {"status":"OK","agent":"single_cf","entry":fqname,"result":res}
    # ไม่เจออะไรเรียกได้
    try:
        ...
        exports = []
    return {"status":"NOOP","agent":"single_cf","reason":"No callable entrypoint discovered","exports":exports}
