# Universal auto-generated wrapper v2 for 'variance_standard'
...
def run(payload=None):
    ...
    try:
        ...
        exports = []
    return {"status":"NOOP","agent":"variance_standard","reason":"No runnable entrypoint found","exports":exports}
