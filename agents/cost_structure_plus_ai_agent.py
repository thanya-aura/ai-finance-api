# Universal auto-generated wrapper v3 for 'cost_structure_plus'
from importlib import import_module
import pkgutil, inspect

ROOT_PKG = "agents._vendor.cost_structure_plus"
...
def _call_entry(entry, payload):
    try:
        ...
        return {"status":"ERROR","agent":"cost_structure_plus","error":str(e)}
...
def run(payload=None):
    ...
    for _, fqname, entry, _ in _CANDS[:10]:  # ลองตัวเต็ง 10 อันดับแรก
        ...
        if isinstance(res, dict) and res.get("status")=="ERROR":
            ...
            continue
        # สำเร็จ
        return {"status":"OK","agent":"cost_structure_plus","entry":fqname,"result":res}
    # ไม่เจออะไรเรียกได้
    try:
        ...
        exports = []
    return {"status":"NOOP","agent":"cost_structure_plus","reason":"No callable entrypoint discovered","exports":exports}
