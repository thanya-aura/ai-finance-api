# Universal auto-generated wrapper v3 for 'capex_standard'
from importlib import import_module
import pkgutil, inspect, asyncio

ROOT_PKG = "agents._vendor.capex_standard"
...
def _call_entry(entry, payload):
    ...
    try:
        ...
        return {"status":"ERROR","agent":"capex_standard","error":str(e)}
def run(payload=None):
    ...
    for _, fqname, entry, _ in _CANDS[:10]:  # ลองตัวเต็ง 10 อันดับแรก
        ...
        if isinstance(res, dict) and res.get("status")=="ERROR":
            ...
            continue
        # สำเร็จ
        return {"status":"OK","agent":"capex_standard","entry":fqname,"result":res}
    # ไม่เจออะไรเรียกได้
    try:
        ...
        exports = []
    return {"status":"NOOP","agent":"capex_standard","reason":"No callable entrypoint discovered","exports":exports}
