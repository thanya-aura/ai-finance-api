# Universal auto-generated wrapper v3 for 'capex_premium'
from importlib import import_module
import pkgutil, inspect

ROOT_PKG = "agents._vendor.capex_premium"
...
def _call_entry(entry, payload):
    try:
        ...
        return {"status":"ERROR","agent":"capex_premium","error":str(e)}
...
def run(payload=None):
    ...
    for _, fqname, entry, _ in _CANDS[:10]:  # ลองตัวเต็ง 10 อันดับแรก
        ...
        if isinstance(res, dict) and res.get("status")=="ERROR":
            ...
            continue
        # สำเร็จ
        return {"status":"OK","agent":"capex_premium","entry":fqname,"result":res}
    # ไม่เจออะไรเรียกได้
    try:
        ...
        exports = []
    return {"status":"NOOP","agent":"capex_premium","reason":"No callable entrypoint discovered","exports":exports}
