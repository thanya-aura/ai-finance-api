# Universal auto-generated wrapper v3 for 'fx_plus'
from importlib import import_module
import pkgutil, inspect, asyncio

ROOT_PKG = "agents._vendor.fx_plus"
...
def _call_entry(entry, payload):
    ...
    try:
        ...
        return {"status":"ERROR","agent":"fx_plus","error":str(e)}
def run(payload=None):
    ...
    for _, fqname, entry, _ in _CANDS[:10]:  # ลองตัวเต็ง 10 อันดับแรก
        ...
        if isinstance(res, dict) and res.get("status")=="ERROR":
            ...
            continue
        # สำเร็จ
        return {"status":"OK","agent":"fx_plus","entry":fqname,"result":res}
    # ไม่เจออะไรเรียกได้
    try:
        ...
        exports = []
    return {"status":"NOOP","agent":"fx_plus","reason":"No callable entrypoint discovered","exports":exports}
