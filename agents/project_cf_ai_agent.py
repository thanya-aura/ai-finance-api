# Universal auto-generated wrapper v3 for 'project_cf'
from importlib import import_module
import pkgutil, inspect, asyncio

ROOT_PKG = "agents._vendor.project_cf"
...
def _call_entry(entry, payload):
    ...
    try:
        ...
        return {"status":"ERROR","agent":"project_cf","error":str(e)}
def run(payload=None):
    ...
    for _, fqname, entry, _ in _CANDS[:10]:  # ลองตัวเต็ง 10 อันดับแรก
        ...
        if isinstance(res, dict) and res.get("status")=="ERROR":
            ...
            continue
        # สำเร็จ
        return {"status":"OK","agent":"project_cf","entry":fqname,"result":res}
    # ไม่เจออะไรเรียกได้
    try:
        ...
        exports = []
    return {"status":"NOOP","agent":"project_cf","reason":"No callable entrypoint discovered","exports":exports}
